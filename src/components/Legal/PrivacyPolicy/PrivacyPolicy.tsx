        ...
        <section className="privacy-policy-section">
          ...
          <ul>
            <li>
              ...
              We collect information such as which of the pages on NimbleFi you access, the
              frequency of access, and what you click on while on NimbleFi.
            </li>
            <li>
              <i>Device Information. </i>
              {' '}
              We collect information about the device you are using, such as hardware
              model, operating system, application version number, and browser.
            </li>
            <li>
              <i>Mobile Device Information. </i>
              {' '}
            ...
            <li>
              ...
              {' '}
              We collect location information from NimbleFi visitors on a city-regional
              basis.
            </li>
          </ul>
          <p>
