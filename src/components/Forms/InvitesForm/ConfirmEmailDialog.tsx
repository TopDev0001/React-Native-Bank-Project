...
import {
  AlertDialog, AlertDialogContent, AlertDialogTitle, AlertDialogDescription, AlertDialogCancel, AlertDialogAction
} from '../../Common/AlertDialog';
import { IConfirmEmailDialog } from './types';

const ConfirmEmailDialog: FC<IConfirmEmailDialog> = (
  props
) => (
