...
const StepTermsAndConditionsView = ({
  props, isChecked, onCheck, onButtonClick, isOpen, onAction
  ...
  >
    ...
    <div className="terms-footer">
      <div className="checkbox-with-text">
        <Checkbox checked={isChecked} onChange={onCheck} name="termsAccept" id="termscheckbox" />
        <p>
          <label htmlFor="termscheckbox">I acknowledge and agree with NimbleFi Terms of Use.</label>
        </p>
      </div>
