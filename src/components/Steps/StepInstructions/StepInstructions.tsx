...
const StepInstructions: React.FC<IStepInstructions> = (
  props
) => {
    ...
    >
      <div className="ni-step-instructions-illustration">
        ...
        <p>
          {institution?.name}
          {' '}
          uses NimbleFi as a third-party technology platform
      ...
      <div className="ni-step-instructions-content">
        ...
        <ol>
          <li>
            <span>
              ...
              {' '}
              <br />
              <small>Please have your driver&apos;s license readily available</small>
            </span>
          </li>
          <li>
            <span>
        ...
        <span className="consent-text">
          By clicking “Let&apos;s Go” you acknowledge and agree that the information
          collected herein is being collected by and provided to
          {' '}
          {institution?.name}
          {' '}
          and, its agents, including SwitchTech, LLC d/b/a
