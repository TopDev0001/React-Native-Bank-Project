...
export const UrlProvider: React.FC<IProvider> = ({ children }) => {
  ...
  const referredById = searchParams.get(magicStrings.urlSearchParams.referredById);

  useEffect(() => {
    if (referredById) sessionStorage.setItem(magicStrings.props.referredById, referredById);
