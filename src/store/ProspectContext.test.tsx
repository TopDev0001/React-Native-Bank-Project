...
const renderApp = (props: IProps) => render(
  <ProspectProvider>
    <ProspectContext.Consumer>
      {(context) => {
        ...
        return (
          <div>
            <button onClick={handleUpdate} data-testid="update" aria-label="update" />
            <button onClick={handlePopulate} data-testid="populate" aria-label="populate" />
            <button onClick={handleSend} data-testid="sendData" aria-label="sendData" />
            <button onClick={updateIds} data-testid="updateIds" aria-label="updateIds" />
            <button onClick={addInviteToState} data-testid="setInvitees" aria-label="setInvitees" />
            <button onClick={addProductsToState} data-testid="addProduct" aria-label="addProduct" />
            <button
