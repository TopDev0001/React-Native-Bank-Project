...
class Config {
  ...
  constructor() {
    const env = ((window as { [key: string]: any })._env_ as {
      [key: string]: any;
    ...
    this.featureConfig.loans.enabled = env.REACT_APP_FEATURE_LOANS_ENABLED === 'true';
    ...
    this.featureConfig.cards.enabled = env.REACT_APP_FEATURE_CARDS_ENABLED === 'true';
  }
